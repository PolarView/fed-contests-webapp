...
export default function Home() {
  return (
    <main className="h-screen w-screen flex items-center  flex-col p-4  overflow-x-hidden">
      ...
      <div className="w-[90%] tracking-wide mt-10 mb-12 mb-2 text-3xl md:text-4xl lg:text-6xl font-bold text-center">
        Квалификация
      </div>
      ...
      <div className="w-[90%] mt-10 mb-12 tracking-wide mb-2 text-3xl md:text-4xl lg:text-6xl font-bold text-center">
        Финал
      </div>
